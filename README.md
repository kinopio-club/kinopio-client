...
| `components/CanvasPaintLayers.vue` | The canvas layers used for animating painting, scroll locking on touch, and more. As well as for multiple card and connection selection which reveals `MultipleSelectedActions` |
