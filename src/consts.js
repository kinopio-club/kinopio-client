...
export default {
  ...
  apiHost () {
    let host = 'https://api.kinopio.club' // https://kinopio-server-production.up.railway.app
    if (this.isDevelopment()) {
  ...
  websocketHost () {
    let host = 'wss://api.kinopio.club' // https://kinopio-server-production.up.railway.app
    if (this.isDevelopment()) {
