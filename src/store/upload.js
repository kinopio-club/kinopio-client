...
export default {
  ...
  actions: {
    ...
    addCardsAndUploadFiles: async (context, { files, currentCursor }) => {
      ...
      if (!canEditSpace) {
        context.commit('addNotificationWithPosition', { message: 'Space is Read Only', position: currentCursor, type: 'info', layer: 'space' }, { root: true })
      ...
      if (!currentUserIsSignedIn) {
        context.commit('addNotificationWithPosition', { message: 'Sign Up or In', position: currentCursor, type: 'info', layer: 'space' }, { root: true })
      ...
      if (filesTooBig) {
        context.commit('addNotificationWithPosition', { message: 'Too Big', position: currentCursor, type: 'danger', layer: 'space' }, { root: true })
      ...
      await Promise.all(files.map(async (file, index) => {
        ...
        try {
          ...
          console.error('🚒', error)
          context.commit('addNotificationWithPosition', { message: error.message, position: currentCursor, type: 'danger', layer: 'space' }, { root: true })
