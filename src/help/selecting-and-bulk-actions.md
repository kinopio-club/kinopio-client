...
description: "You can move or edit multiple cards and connections at once by dragging from an empty area to paint over them. Being able to move and edit many cards together is one of Kinopio's most powerful features."
category: Basics
---
...
<video class="large" autoplay loop muted playsinline>
  <source src="@/assets/pages/help/posts/selecting-and-bulk-actions/demo.mp4">
</video>
...
<video class="large" autoplay loop muted playsinline>
  <source src="@/assets/pages/help/posts/selecting-and-bulk-actions/box-select.mp4">
</video>
...
<video class="large" autoplay loop muted playsinline>
  <source src="@/assets/pages/help/posts/selecting-and-bulk-actions/select-below.mp4">
</video>
