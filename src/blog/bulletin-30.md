...
The big new release is [Card Links](https://kinopio.club/blog/card-links): Every card now has it's own URL you can share anywhere,
...
[New Community Backgrounds](https://kinopio.club/blog/community-backgrounds) One of the first things people do when creating a new space is choosing a background for it. The right image sets the tone for what follows.
...
- [Faster and smoother paint selection](https://kinopio.club/blog/magic-paint-select)
- [Updated hello space](https://kinopio.club/blog/updated-hello-space) for new users
