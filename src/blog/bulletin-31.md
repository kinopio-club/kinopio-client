...
While I was in Bali [last month](https://kinopio.club/blog/bulletin-30), I had lunch with [Lucas](https://lucas.love) and asked if he'd be interested in making a Kinopio iOS app. Over the last month we've been making steady progress on the app, which you can [preview here](https://testflight.apple.com/join/VoN2TmsM).
...
My personal favorite update this month is the ability to [Embed Any Site](https://kinopio.club/blog/embed-any-site), like Spotify, Bandcamp, or code Gists. Just paste the URLs and if there's a media player or something fancy for it, you'll be able to use it inline.
...
[Journal Prompt of the Day](https://kinopio.club/blog/journal-prompt-of-the-day) generates a new journaling prompt each day.
...
[Card Counters](https://kinopio.club/blog/card-counters) let your collaborators vote on ideas.

[Public Presence and Painting](https://kinopio.club/blog/public-presence-painting) broadcasts spectator cursor position and paint strokes out to everyone viewing the space.
