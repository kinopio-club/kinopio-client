...
![](https://updates.kinopio.club/pages/blog/posts/guides/life-tasks1.png)

Your personal space should reflect your personality. Besides tasks and ideas, add personal photos, a [background](https://kinopio.club/help/changing-space-background/), and cool [images](https://kinopio.club/help/card-images/) that inspire you right now.

Your system doesn't have to make sense to anyone but you, and you can use [privacy](https://kinopio.club/help/sharing/) options to make it as private or public as you want.

## How do you collect and organize info on your space?

![](https://updates.kinopio.club/pages/blog/posts/guides/life-tasks5.png)

I'd start by just writing out all the tasks floating inside my head. Use [checkboxes](https://kinopio.club/help/checkbox-cards/) to turn the short-term actions into tasks.
