...
- [Generated Backgrounds and Translucent Buttons](https://kinopio.club/blog/generated-backgrounds) make finding the right vibe that much easier.
...
- If you don't like subscriptions, you can now purchase a [Lifetime Plan](https://kinopio.club/blog/lifetime-plan) for $200 instead.

- [Bigger, Better Code Blocks](https://kinopio.club/blog/bigger-better-code-blocks) with syntax highlighting and a higher character limit when you paste code into cards between `triple backticks` ```.
...
- [Read-Only Invites](https://kinopio.club/blog/read-only-invite) let someone else view a private space – but not edit it.
