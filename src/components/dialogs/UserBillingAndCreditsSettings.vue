...
const subscriptionIsApple = computed(() => store.state.currentUser.appleSubscriptionIsActive)
const subscriptionIsStripe = computed(() => store.state.currentUser.stripeSubscriptionId)
