...
export default {
  ...
  computed: {
    ...
    cardUrlPreviewIsVisible () {
      ...
      // experiment: remove urlPreviewErrorUrl checking to eliminate false positives. Observe if there's a downside irl and if this attribute should be removed entirely?
