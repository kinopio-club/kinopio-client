...
section.for-work
  ...
  .for-work-wrap
    ...
    p Capture and connect ideas together, build them up into plans, lists, and tasks assigned to team-mates. Planning and progress in the same space keeps everyone aligned.
    figure
